...
function generateCards() {
  ...
  users.forEach(function (el) {
    html = html + "<tr class=\"row_list\">\n                    <td class=\"row_list__item\">".concat(el.customerName, "</td>\n                    <td class=\"row_list__item\">").concat(el.company, "</td>\n                    <td class=\"row_list__item\">").concat(el.phoneNumber, "</td>\n                    <td class=\"row_list__item\">").concat(el.email, "</td>\n                    <td class=\"row_list__item\">").concat(el.country, "</td>\n                    <td class=\"row_list__item\">").concat(el.userStatus, "</td>\n                </tr>");
  });
  html = html + "</tbody>";
  html = html + '</table>';
...
function sort(columnIndex) {
  ...
  var number = columnIndex === -1 || columnIndex === 6;
